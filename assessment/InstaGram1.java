...
public class InstaGram1 {
	...
	public void loginfail() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
				+ "android.widget.LinearLayout/android.widget.FrameLayout/"
				+ "android.widget.FrameLayout/android.widget.FrameLayout/"
				+ "android.view.ViewGroup[3]/android.widget.MultiAutoCompleteTextView[1]")).sendKeys("pari_45");
		Thread.sleep(1000);
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
				+ "android.widget.LinearLayout/android.widget.FrameLayout/"
				+ "android.widget.FrameLayout/android.widget.FrameLayout/"
				+ "android.view.ViewGroup[3]/android.widget.MultiAutoCompleteTextView[2]")).sendKeys("Adm@123");
		Thread.sleep(1000);
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/"
				+ "android.widget.LinearLayout/android.widget.FrameLayout/"
				+ "android.widget.FrameLayout/android.widget.FrameLayout/"
		...
		Files.copy(file, new File("D:\\Selenium\\ss\\instalogin2.png"));
		Thread.sleep(10000);
		driver.quit();
}
}
